...
* Content
  * [WorkShop-1](#workshop-1-aws-cdk--aws-cloudformation)
  * [WorkShop-2](#workshop-2-domain-driven-design)
  * [WorkShop-3](#workshop-3-hashicorp-community﻿)
  * [Reference](#Reference)
...
![CoffeeMapFull](https://imgur.com/c2kNMNp.jpg)
  
> CoffeeMapExtand
  
![CoffeeMapExtand](https://imgur.com/juvgcb0.jpg)
  
> CoffeeMapMarkAPI
  
![CoffeeMapMarkAPI](https://imgur.com/N1hnD6a.jpg)
  
> CoffeeMap3Party
  
![CoffeeMap3Party](https://imgur.com/OHrikCB.jpg)
  
> CoffeeMapAPIDefine
  
![CoffeeMapAPIDefine](https://imgur.com/pIE494A.jpg)
  
### Bounded CONTEXT  
  
Bind and Bound out the bordering / Mark down the Limition:  
  
![CoffeeMapMarkSystem](https://imgur.com/0YCr9pE.jpg)
  
### Finalization on DDD  
  
* Boundering to Domain and call Domain Knowledger to join and make thing perfect.  
* Calling Sub-Domain Knowledger to make perfect. (EX. Packaging to 3-Party finished the system.)
* Split out the Core / Inner / Outer On System.
  
> TopView
  
![TopView](https://imgur.com/WAhUGdj.jpg)  
  
> FinalPrototype
  
![FinalPrototype](https://imgur.com/NjiyhDV.jpg)
  
* ANTICORRUPTION LAYER
 * Define a "GOOGLE Translator"-like API to check 3-Party API schema.
  
# [WorkShop-3] Hashicorp Community  
  
[Hack 'n' Roll_ Kubernetes from Zero to Hero](Hack%20'n'%20Roll_%20Kubernetes%20from%20Zero%20to%20Hero.pdf)
  
# Reference  
  
[Using troposphere Manual](https://akishinoshiame.github.io/AWS_Hack-n-Roll/)  
